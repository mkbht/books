...
var isFirst = false;
var isLast = false;
var TitleName = "Laky Men Cup Ramen";
var SkuName = "Spicy 440";
...
$(linkSelector).click(function (e) {
    ...
    openLumos(clickedImage, galleryName, TitleName, SkuName);
});
$(prevButton).click(function () {
    if (isFirst) { return; }
    openLumos(getNextImage("prev"), lumosGalleryName.text(),  TitleName, SkuName);
});
$(nextButton).click(function () {
    if (isLast) { return; }
    openLumos(getNextImage("next"), lumosGalleryName.text(),  TitleName, SkuName);
});
...
// Open
function openLumos(imageToOpen, galleryName,  TitleName, SkuName) {
	...
	$(".popTitle").html(TitleName);
	$(".popSku").html('<span>'+SkuName+'</span>');
    getAltText();
}
